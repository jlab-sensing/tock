...
mod test {
    ...
    use super::util;
    use super::util::Expiration;
    use super::AlarmDriver;
    ...
    fn test_earliest_alarm_no_alarms() {
        assert!(
            util::earliest_alarm::<'_, _, _, MockAlarm<Ticks32, Freq10MHz>, _>(
                // Now:
                Ticks32::from(42_u32),
                // Expirations:
                <[(
    ...
    fn test_earliest_alarm_multiple_unexpired() {
        ...
        let (earliest, id) = util::earliest_alarm::<'_, _, _, MockAlarm<Ticks32, Freq10MHz>, _>(
            // Now:
            42_u32.into(),
            // Expirations:
            [
